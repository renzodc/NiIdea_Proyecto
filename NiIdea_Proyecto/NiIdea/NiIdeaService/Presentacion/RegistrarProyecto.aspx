<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrarProyecto.aspx.cs" Inherits="NiIdeaService.Presentacion.RegistrarProyecto" %>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  href="RegistrarProyecto.aspx"><i class="fa fa-dashboard fa-3x"></i> Proyecto</a>
                    </li>
                     <li>
...
<%--                        <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">
            ...
            <%--           <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    ...
                    <div class="col-md-6">
                        <p class="main-text">Contacto</p>
                        <input class="form-control" placeholder="" style="width:300px"/>

                        <p class="main-text">Contacto Tlf.</p>
                        <input class="form-control" placeholder="" style="width:300px"/>
                    </div>   
