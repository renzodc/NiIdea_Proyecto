<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrarCotizacion.aspx.cs" Inherits="NiIdeaService.Presentacion.RegistrarCotizacion" %>
...
font-size: 16px;"><!-- Last access : 30 May 2014 &nbsp; --><a href="#" class="btn btn-danger square-btn-adjust">Logout</a> 
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a class="active-menu"  href="RegistrarCotizacion.aspx"><i class="fa fa-desktop fa-3x"></i>Cotización</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div>
                    <div class="col-md-6">
                        <p class="main-text">Projecto</p>
                        <select class="form-control" style="width:300px">                   
                        <option>-- Seleccione --</option></select>  

                        <p class="main-text">Servicio</p>
                        <select class="form-control" style="width:300px">                   
                        <option>-- Seleccione --</option></select>    

                        <p class="main-text">Puntos a Monitorear</p>
                        <input class="form-control" placeholder="" style="width:300px"/>

                        <p class="main-text">Monto Total</p>
                        <input class="form-control" placeholder="" style="width:300px"/>

                        <p class="main-text">Descripción</p>
                        <textarea class="form-control" rows="2" style="width:600px;height:150px"></textarea>
